...
- Right-click the CC-Gateway-Pro icon in the system tray
...
If Claude Code prompts you to **log in** or shows an onboarding wizard on first launch, enable the "Skip Claude Code first-run confirmation" option in CC-Gateway-Pro:

1. Open CC-Gateway-Pro "Settings > General"
