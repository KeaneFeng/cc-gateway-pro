...
2. CC-Gateway-Pro updates the configuration file
...
1. Right-click the CC-Gateway-Pro icon in the system tray
...
When switching providers, CC-Gateway-Pro modifies the following files:
