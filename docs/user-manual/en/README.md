# CC-Gateway-Pro User Manual

> Local provider manager and proxy gateway for Claude Code / Claude Desktop / Codex / Gemini CLI / OpenCode / OpenClaw / Hermes Agent
...
| File                                               | Description                                            |
| -------------------------------------------------- | ------------------------------------------------------ |
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | CC-Gateway-Pro storage, CLI configuration file formats |
...
- **Architecture and flow diagrams**: See [Architecture and Flows](../../architecture-and-flows-zh.md)
- **Having trouble**: See [5.2 FAQ](./5-faq/5.2-questions.md)

## Version Information

- Documentation version: v3.15.17
- Last updated: 2026-06-01
- Applicable to CC-Gateway-Pro v3.15.17+

## Project Note

CC-Gateway-Pro is forked from [farion1231/cc-switch](https://github.com/farion1231/cc-switch). It keeps the original visual provider switching workflow and extends it with a local proxy gateway, Claude/Codex project-level provider binding, Vision Model auto-routing, Claude Desktop third-party integration, failover, usage analytics, and multi-app extension management.
...
- **OpenCode / OpenClaw Stream Check Coverage**: Stream Check panel extended to all supported apps — see [4.5 Model Test](./4-proxy/4.5-model-test.md)
