...
CC-Gateway-Pro provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
ccgatewaypro://import/prompt?data=<base64-encoded preset>
```
