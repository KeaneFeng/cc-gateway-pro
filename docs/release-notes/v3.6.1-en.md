# CC-Gateway-Pro v3.6.1

> Stability improvements and user experience optimization (based on v3.6.0)

**[中文更新说明 Chinese Documentation →](https://github.com/KeaneFeng/cc-gateway-pro/blob/main/docs/release-notes/v3.6.1-zh.md)**
...
- [中文文档 (Chinese)](https://github.com/KeaneFeng/cc-gateway-pro/blob/main/README_ZH.md)
- [English Documentation](https://github.com/KeaneFeng/cc-gateway-pro/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/KeaneFeng/cc-gateway-pro/blob/main/CHANGELOG.md)
...
**Full Changelog**: https://github.com/KeaneFeng/cc-gateway-pro/compare/v3.6.0...v3.6.1
...
- **Customizable Storage Location** - Customize CC-Gateway-Pro's configuration storage directory
...
## 🌟 About CC-Gateway-Pro

CC-Gateway-Pro is a cross-platform desktop application for managing and switching between different provider configurations for Claude Code and Codex. Built with Tauri 2.0 + React 18 + TypeScript, supporting Windows, macOS, and Linux.
...
**Project Repository**: https://github.com/KeaneFeng/cc-gateway-pro
