...
CC-Gateway-Pro v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
- [@KeaneFeng](https://github.com/KeaneFeng) - Bug fixes and feature enhancements
...
[Use code "cc-gateway-pro" for 10% off registration](https://www.packyapi.com/register?aff=cc-gateway-pro)
...
- **Issue Reports**: [GitHub Issues](https://github.com/KeaneFeng/cc-gateway-pro/issues)
