...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S cc-gateway-pro-bin`
...
访问 [Releases](https://github.com/KeaneFeng/cc-gateway-pro/releases/latest) 下载最新版本
...
v3.7.0 代表了 CC-Gateway-Pro 定位的转变：
...
访问 [Releases](https://github.com/KeaneFeng/cc-gateway-pro/releases/latest) 下载：
...
- [@KeaneFeng](https://github.com/KeaneFeng) - 从开发沦为 issue 回复机
- 社区成员的测试和反馈
...
[使用 "cc-gateway-pro" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=cc-gateway-pro)
...
- **问题反馈**：[GitHub Issues](https://github.com/KeaneFeng/cc-gateway-pro/issues)
- **讨论**：[GitHub Discussions](https://github.com/KeaneFeng/cc-gateway-pro/discussions)
