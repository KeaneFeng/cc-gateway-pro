...
>
> CC-Gateway-Pro is a **fully free and open-source** desktop app, and we **do not charge users any fees**. Multiple imposter websites have recently been spotted impersonating CC-Gateway-Pro to solicit payments and harvest account credentials, with some users already reporting financial losses. Please only obtain the software through the official channels listed below:
>
> | Channel            | Only Official                                                                  |
> | ------------------ | ------------------------------------------------------------------------------ |
> | Website            | **[ccgatewaypro.io](https://ccgatewaypro.io)**                                         |
> | Source             | **[github.com/KeaneFeng/cc-gateway-pro](https://github.com/KeaneFeng/cc-gateway-pro)** |
> | Downloads          | **[GitHub Releases](https://github.com/KeaneFeng/cc-gateway-pro/releases)**        |
> | Author             | **[@KeaneFeng](https://github.com/KeaneFeng)**                               |
> | Report an Imposter | **[GitHub Issues](https://github.com/KeaneFeng/cc-gateway-pro/issues)**            |
>
> **Any "CC-Gateway-Pro" website or client that asks you for payment, top-ups, or login credentials is fake.** If you have been tricked into paying, stop the transaction immediately and file a report through GitHub Issues so we can take down the imposter site as quickly as possible.
...
**[Use CC-Gateway-Pro to configure, manage, and switch Claude Desktop providers in one place](../user-manual/en/2-providers/2.6-claude-desktop.md)**
...
CC-Gateway-Pro now treats **Claude Desktop** as a first-class managed surface alongside Claude Code / Codex / Gemini / OpenCode / OpenClaw / Hermes.

- New dedicated Claude Desktop panel that brokers third-party providers to Claude Desktop through CC-Gateway-Pro's in-app proxy gateway
...
ChatGPT Codex providers no longer rely on a hardcoded model selection — CC-Gateway-Pro fetches a **live model list** from the ChatGPT backend on demand.
...
Switching a Claude Desktop provider writes CC-Gateway-Pro's managed 3P profile and **requires restarting Claude Desktop** to take effect; proxy-mode providers require CC-Gateway-Pro's Local Routing to stay running while in use.
...
### CC-Gateway-Pro Brand Surface Unified to ccgatewaypro.io

All in-app and README "official website" references now point at ccgatewaypro.io as the sole official site; the release notes template also surfaces ccgatewaypro.io.
...
The release notes template now surfaces `ccgatewaypro.io`.

### Brand Surface

Documented `ccgatewaypro.io` as the sole official website across READMEs and in-app references.
...
**Claude Desktop Third-Party Provider Switching via Proxy Gateway**: Routing Claude Desktop traffic through CC-Gateway-Pro's in-app proxy gateway to a third-party provider exposes those requests to that provider's billing, compliance, and data-retention policies — read the target provider's terms of service before using.

By enabling these features, users **accept all associated risks**. CC-Gateway-Pro is not responsible for any account restrictions, warnings, or service suspensions that result from using these features.

---

## Download & Installation

Visit [Releases](https://github.com/KeaneFeng/cc-gateway-pro/releases/latest) to download the appropriate version.
