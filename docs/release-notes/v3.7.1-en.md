...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S cc-gateway-pro-bin`
...
Visit [Releases](https://github.com/KeaneFeng/cc-gateway-pro/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `ccgatewaypro://` protocol
...
v3.7.0 represents a shift in CC-Gateway-Pro's positioning:
...
Visit [Releases](https://github.com/KeaneFeng/cc-gateway-pro/releases/latest) to download:

- **Windows**: `CC-Switch-Windows.msi` or `-Portable.zip`
- **macOS**: `CC-Switch-macOS.tar.gz` or `.zip`
- **Linux**: `CC-Switch-Linux.AppImage` or `.deb`
- **ArchLinux**: `paru -S cc-gateway-pro-bin`
...
- [@KeaneFeng](https://github.com/KeaneFeng) - From developer to issue responder
...
[Register with "cc-gateway-pro" code for 10% discount](https://www.packyapi.com/register?aff=cc-gateway-pro)
...
- **Issues**: [GitHub Issues](https://github.com/KeaneFeng/cc-gateway-pro/issues)
- **Discussions**: [GitHub Discussions](https://github.com/KeaneFeng/cc-gateway-pro/discussions)
