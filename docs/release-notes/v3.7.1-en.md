...
Visit [Releases](https://github.com/farion1231/cc-gateway-pro/releases/latest) to download the latest version
...
Visit [Releases](https://github.com/farion1231/cc-gateway-pro/releases/latest) to download:
...
- **Issues**: [GitHub Issues](https://github.com/farion1231/cc-gateway-pro/issues)
- **Discussions**: [GitHub Discussions](https://github.com/farion1231/cc-gateway-pro/discussions)
