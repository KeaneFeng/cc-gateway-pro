...
CC-Gateway-Pro v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/KeaneFeng/cc-gateway-pro/releases/latest) から入手:
...
- [@KeaneFeng](https://github.com/KeaneFeng) - バグ修正と機能拡張
...
[登録時に「cc-gateway-pro」で 10% オフ](https://www.packyapi.com/register?aff=cc-gateway-pro)
...
- **Issue**: [GitHub Issues](https://github.com/KeaneFeng/cc-gateway-pro/issues)
