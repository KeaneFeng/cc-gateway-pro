          ...
          <div className="space-y-1">
            ...
            <p className="text-xs leading-relaxed text-muted-foreground">
              {t("codexConfig.modelMappingHint", {
                defaultValue:
                  "选择模型角色后，CC Gateway Pro 会自动生成 Codex 兼容路由；菜单显示名可以填 DeepSeek、Kimi 等品牌模型，实际请求模型按右侧填写内容发送。",
              })}
            </p>
          </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            {t("providerForm.visionModelHint", {
              defaultValue:
                "Automatically switch to this model when the request contains images. Leave empty to use the default model.",
            })}
          </p>
        </div>
      )}
