...
const PROTOCOL_FORMAT: &str = "cc-gateway-pro-webdav-sync";
...
mod tests {
    ...
    fn remote_dir_segments_uses_current_layout() {
        ...
        assert_eq!(segs, vec!["cc-gateway-pro-sync", "v2", "db-v6", "default"]);
    }
    ...
    fn remote_dir_segments_uses_legacy_layout() {
        ...
        assert_eq!(segs, vec!["cc-gateway-pro-sync", "v2", "default"]);
    }
