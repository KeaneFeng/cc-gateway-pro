//! Deep link import functionality for CC-Gateway-Pro
//!
//! This module implements the ccgatewaypro:// protocol for importing configurations
...
///
/// Represents a parsed ccgatewaypro:// URL ready for processing.
