...
//!
//! 本模块处理 CC-Gateway-Pro 统一 MCP 格式与 OpenCode 格式之间的转换。
//!
//! ## 格式差异
//!
//! | CC-Gateway-Pro 统一格式    | OpenCode 格式       |
//! |----------------------|---------------------|
...
// ============================================================================
// Format Conversion: CC-Gateway-Pro → OpenCode
// ============================================================================

/// Convert CC-Gateway-Pro unified format to OpenCode format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: OpenCode → CC-Gateway-Pro
// ============================================================================

/// Convert OpenCode format to CC-Gateway-Pro unified format
///
/// Conversion rules:
